...
def id3(data, target_col):
    ...
    # If there are no more features to split on, return the majority target value
    ...
    for value in unique_values:
        subtree_data = data[data[best_feature] == value].drop(best_feature, axis=1)
...
def calc_info_gain(data, feature, target_col):
    ...
    for value in unique_values:
        ...
        entropy_after_split += subset_weight * calc_entropy(subset[target_col])
...
new_sample = {"Outlook": "sunny", "Temp": "cool", "Humidity": "normal", "Wind": "True"}
